...
Partial Class MDIParent1
    ...
    Private Sub InitializeComponent()
        ...
        'OpenImageFileDialog
        '
        Me.OpenImageFileDialog.FileName = "*.png"
        Me.OpenImageFileDialog.Filter = "PNG|*.png|JPG|*.jpg|GIF|*.gif|Alle|*.*"
        Me.OpenImageFileDialog.Title = "Bilddatei öffnen"
        '
        'MDIParent1
        '
    ...
    Friend WithEvents OpenImageFileDialog As System.Windows.Forms.OpenFileDialog
